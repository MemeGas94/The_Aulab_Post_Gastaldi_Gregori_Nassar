...
class WriterController extends Controller
{
    public function dashboard(){
        $unrevisionArticles = Article::where('user_id', Auth::user()->id)->where('is_accepted', NULL)->orderBy('created_at', 'desc')->get();
        ...
        return view ('writer.dashboard',compact('unrevisionArticles','acceptedArticles','rejectedArticles'));
    }
